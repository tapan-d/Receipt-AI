  ...
  return (
    <>
      <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
        ...
        {/* Payment / Rewards */}
        {(receipt.payment_method || receipt.reward_program_name) && (
          <div style={{ background: 'white', border: '1.5px solid #E2E4EE', borderRadius: 16, padding: '14px 16px', display: 'flex', flexDirection: 'column', gap: 10 }}>
            {receipt.payment_method && (
              <div style={{ display: 'flex', justifyContent: 'space-between' }}>
                <span style={{ fontSize: 13, color: '#7B8099' }}>Payment</span>
                <span style={{ fontSize: 13, color: '#0D0F1A', fontWeight: 500 }}>
            ...
            {receipt.reward_program_name && (
              <div style={{ display: 'flex', justifyContent: 'space-between' }}>
                <span style={{ fontSize: 13, color: '#7B8099' }}>Rewards</span>
                <span style={{ fontSize: 13, color: '#0D0F1A', fontWeight: 500 }}>{receipt.reward_program_name}</span>
              </div>
            )}
          </div>
        )}
